...
vars <- c("age", "sex", "race", "length.stay", "disposition")
fvars <- c("sex", "race", "disposition")
...
2. etoh.high = EtOH level was > 0.08
3. uds.pos = UDS was positive, excluding benzodiazepines and opiates
